...
class SegNet(nn.Module):
    def __init__(self, num_classes, in_channels=3, path_model=None):
        ...
        self.stage1_decoder = nn.Sequential(*decoder[0:9], nn.Dropout2d(p=0.5))
        self.stage2_decoder = nn.Sequential(*decoder[9:18], nn.Dropout2d(p=0.5))
        self.stage3_decoder = nn.Sequential(*decoder[18:27], nn.Dropout2d(p=0.5))
        self.stage4_decoder = nn.Sequential(*decoder[27:33], nn.Dropout2d(p=0.5))
